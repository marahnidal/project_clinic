...
<!-- Navbar End -->
 ...
 <div class="mb-3 container m-5" >
  <div class="row g-0">
    <div class="col-md-4">
      <img src="{{ asset('siteassets/img/د اسامة.jfif') }}" class="img-fluid rounded-start" style="box-shadow: 10px 10px 10px 10px #888888 !important;">
    </div>
    <div class="col-md-8">
      <div class="card-body m-4">
        <h5 class="display-6 mb-5" style="font-family: 'Cairo', sans-serif !important; ">الدكتور أسامة الترك</h5>
        <p class="card-text fs-5">دكتوراه بالأمراض الجلدية والعناية بالبشرة  </p>
        <p class="card-text fs-5"> درس في فرنسا   </p>
        <p class="card-text fs-5">   المكان : غزة شارع الثلاثيني عمارة أبو غزالة </p>
      </div>
    </div>
  </div>
</div>
