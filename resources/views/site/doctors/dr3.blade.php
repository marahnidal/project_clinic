...
<!-- Navbar End -->
 ...
 <div class="mb-3 container m-5" >
  <div class="row g-0">
    <div class="col-md-4">
      <img src="{{ asset('siteassets/img/team-3.png') }}" class="img-fluid rounded-start" style="box-shadow: 10px 10px 10px 10px #888888 !important;">
    </div>
    <div class="col-md-8">
      <div class="card-body m-4">
        <h5 class="display-6 mb-5" style="font-family: 'Cairo', sans-serif !important; ">الدكتورة هبة الهسي</h5>
        <p class="card-text fs-5">أخصائية الأمراض الجلدية والتجميل والليزر    </p>
        <p class="card-text fs-5"> المكان : غزة، السرايا بجوار صيدلية مسلم   </p>
