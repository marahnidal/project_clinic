...
<!-- Navbar End -->
 ...
 <div class="mb-3 container m-5" >
  <div class="row g-0">
    <div class="col-md-4">
      <img src="{{ asset('siteassets/img/team-11.jpg') }}" class="img-fluid rounded-start" style="box-shadow: 10px 10px 10px 10px #888888 !important;">
    </div>
    <div class="col-md-8">
      <div class="card-body m-4">
        <h5 class="display-6 mb-5" style="font-family: 'Cairo', sans-serif !important; ">الدكتور مجدي نعيم</h5>
        <p class="card-text fs-5">أخصائي بشرة وجلدية في علاج البشرة بالليزر وحب الشباب    </p>
        <p class="card-text fs-5">
             مجدي نعيم للأمراض الجلدية والعناية بالبشرة   </p>
             <p class="card-text fs-5">المكان : غزة شارع النصر بجوار مكتبة النصر المركزية فوق صيدلية الوفيرا عمارة المعتز 5</p>
...
<div class="row">
   ...
   @auth
   <div class="image">
    <img src="{{ asset('siteassets/img/team-11.jpg') }}" alt="" style="box-shadow: 10px 10px 10px 10px #888888 !important;">
</div>
