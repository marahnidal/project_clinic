...
@include('admin.errors')
  ...
  <form method="POST" action="{{ route('admin.skin.store') }}"  >
    @csrf
 <div class="row">
<div class="col-md-6">
    <div class="mb-3">
   ...
   <div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <textarea name="en_content"  class="form-control customarea"></textarea>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <textarea name="ar_content"  class="form-control customarea"></textarea>
        </div>
    </div>
</div>
