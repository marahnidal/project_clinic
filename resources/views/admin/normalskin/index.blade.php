...
@stop
  ...
  <tr>
    ...
    <tr>
        ...
        <td>{{ $normalskin->category->trans_name }}</td>
        <td>
        <a class="btn btn-sm btn-primary" href="{{ route('admin.normalskin.edit', $normalskin->id) }}"><i class="fas fa-edit"></i></a>
        <form class="d-inline" method="POST" action="{{ route('admin.normalskin.destroy' , $normalskin->id) }}">
        @csrf
        @method('delete')
